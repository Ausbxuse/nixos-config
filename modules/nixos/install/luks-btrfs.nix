      ...
      assertions = [
        {
          ...
          message = "hosts using the luks-btrfs install layout must set hostDef.install.disk.";
        }
        {
          assertion = install ? swapSize && install.swapSize != "";
          message = "hosts using the luks-btrfs install layout must set hostDef.install.swapSize.";
        }
      ];
    }
